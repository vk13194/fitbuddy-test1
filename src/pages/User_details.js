...
export default function User_details() {
  ...
  function encodeImageFileAsURL(element) {
    ...
    if (file != undefined) {
      ...
      document.getElementById("profile_label").style.backgroundImage =
  ...
  const registerUser = () => {
    ...
    if (
      document.getElementById("male_gender_button").className ==
      "gender_selected"
    ) {
      gender = "Male";
    } else if (
      document.getElementById("female_gender_button").className ==
      "gender_selected"
    ) {
      gender = "Female";
    }
        ...
        <TextInputs>
          ...
          <div className="details">
            <div className="ctr_1">
              <p>Gender</p>
              <button
                id="male_gender_button"
                onClick={(event) => {
                  if (gender != "" && gender == "Male") {
                    gender = "";
                    event.target.className = "gender_unselected";
                  } else if (gender == "") {
                    gender = "Male";
                    event.target.className = "gender_selected";
                ...
                className="gender_unselected"
                value="Male"
              >
                Male
              </button>
              <button
                id="female_gender_button"
                onClick={(event) => {
          ...
          <div className="bottom_left_ctr" style={{ marginTop: "200px" }}>
            <ProfileImage>
              ...
              <input
                ...
                accept="image/*"
                onChange={() => {
                  encodeImageFileAsURL(document.getElementById("file-upload"));
                }}
              />
            </ProfileImage>
            <label id="loading_label" style={{ display: "none" }}>
            ...
            >
              <Link to="/user/profile">
                <button
                  id="redirectToUserProfileButton"
                  style={{ display: "none" }}
                ></button>
              </Link>
              <Link to="/">
                <button id="redirectToHomePage" hidden="true"></button>
              </Link>
